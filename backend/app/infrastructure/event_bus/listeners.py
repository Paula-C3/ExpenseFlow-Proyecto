    ...
    def handle(self, event: DomainEvent) -> None:
        ...
        if isinstance(event, RequestSubmittedEvent):
            notification = Notification(
                ...
                message=f"Tu solicitud ha sido enviada para revisión",
            ...
            notification = Notification(
                user_id=event.approver_id,
                title="Solicitud aprobada",
                message=f"La solicitud {event.request_id} ha sido aprobada",
            ...
            notification = Notification(
                user_id=event.rejector_id,
                title="Solicitud rechazada",
                message=f"La solicitud {event.request_id} ha sido rechazada",
